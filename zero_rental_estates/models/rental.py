...
class Rental(models.Model):
    ...
    rent_without_charges = fields.Float(string="rent without charges", related='estate_rented.price_rental', default=0.0, digits=dp.get_precision('rent without charges'), required=True)
